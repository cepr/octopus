...
$(IntermediateDirectory)/Eve$(DependSuffix): Eve.cpp
	@$(CompilerName) $(CmpOptions) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Eve$(ObjectSuffix) -MF$(IntermediateDirectory)/Eve$(DependSuffix) -MM "/home/cedric/octopus/git/octopus/robots/Eve/Eve.cpp"
