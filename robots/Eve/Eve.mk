...
ProjectPath            := "/home/cedric/octopus/src/robots/Eve"
CurrentFileName        :=
CurrentFilePath        :=
CurrentFileFullPath    :=
User                   :=Cédric
...
ObjectsFileList        :="/home/cedric/octopus/src/robots/Eve/Eve.txt"
...
## Objects
##
$(IntermediateDirectory)/Eve$(ObjectSuffix): Eve.cpp $(IntermediateDirectory)/Eve$(DependSuffix)
	$(CompilerName) $(SourceSwitch) "/home/cedric/octopus/src/robots/Eve/Eve.cpp" $(CmpOptions) $(ObjectSwitch)$(IntermediateDirectory)/Eve$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Eve$(DependSuffix): Eve.cpp
	@$(CompilerName) $(CmpOptions) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Eve$(ObjectSuffix) -MF$(IntermediateDirectory)/Eve$(DependSuffix) -MM "/home/cedric/octopus/src/robots/Eve/Eve.cpp"

$(IntermediateDirectory)/Eve$(PreprocessSuffix): Eve.cpp
	@$(CompilerName) $(CmpOptions) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Eve$(PreprocessSuffix) "/home/cedric/octopus/src/robots/Eve/Eve.cpp"
