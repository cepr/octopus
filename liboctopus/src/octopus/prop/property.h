...
template<> inline PROPERTY_TYPE _getType<bool>() {
	return PROPERTY_TYPE_BOOL;
}
template<> inline PROPERTY_TYPE _getType<unsigned short>() {
	return PROPERTY_TYPE_U16;
}
template<> inline PROPERTY_TYPE _getType<signed short>() {
	return PROPERTY_TYPE_S16;
}
template<> inline PROPERTY_TYPE _getType<signed char>() {
	return PROPERTY_TYPE_S8;
}
template<> inline PROPERTY_TYPE _getType<unsigned char>() {
	return PROPERTY_TYPE_U8;
}
...
typedef union uPROPERTY_VALUE {
	...
	uPROPERTY_VALUE(bool value) :
			boolean(value) {
	}
	uPROPERTY_VALUE(unsigned short value) :
			u16(value) {
	}
	uPROPERTY_VALUE(signed short value) :
			s16(value) {
	}
	uPROPERTY_VALUE(unsigned char value) :
			u8(value) {
	}
	uPROPERTY_VALUE(signed char value) :
			s8(value) {
	}
	...
	inline signed short operator=(signed short value) {
		return s16 = value;
	}
	inline unsigned char operator=(unsigned char value) {
		return u8 = value;
	}
	inline signed char operator=(signed char value) {
		return s8 = value;
	}
