...
{
	SetAppName(wxT("OctopusControlPanel"));
	SetVendorName(wxT("cedric.priscal@gmail.com"));
}

bool wxOctopusControlPanelApp::OnInit()
{
	wxLogDebug("Welcome to Octopus Control Panel, DEBUG version");

	// load PNG image handler
