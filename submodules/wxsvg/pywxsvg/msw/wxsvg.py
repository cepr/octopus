...
class SVGUIElement(SvgXmlNode):
    ...
    def DefineCenter(*args, **kwargs):
        """DefineCenter(self, SVGPoint pt)"""
        return _wxsvg.SVGUIElement_DefineCenter(*args, **kwargs)

    def GetCenter(*args, **kwargs):
        """GetCenter(self) -> SVGPoint"""
        return _wxsvg.SVGUIElement_GetCenter(*args, **kwargs)
    ...
    def SendMouseEvent(*args, **kwargs):
        """SendMouseEvent(self, MouseEvent event)"""
        return _wxsvg.SVGUIElement_SendMouseEvent(*args, **kwargs)

    def SendKeyEvent(*args, **kwargs):
        """SendKeyEvent(self, KeyEvent event)"""
        return _wxsvg.SVGUIElement_SendKeyEvent(*args, **kwargs)
...
class SVGUIControlBase(SVGUIElement,_core.EvtHandler):
    """Proxy of C++ SVGUIControlBase class"""
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    def Refresh(*args, **kwargs):
        """Refresh(self)"""
        return _wxsvg.SVGUIControlBase_Refresh(*args, **kwargs)

    def OnLeftDown(*args, **kwargs):
        """OnLeftDown(self, MouseEvent event)"""
        return _wxsvg.SVGUIControlBase_OnLeftDown(*args, **kwargs)

    def OnLeftUp(*args, **kwargs):
        """OnLeftUp(self, MouseEvent event)"""
        return _wxsvg.SVGUIControlBase_OnLeftUp(*args, **kwargs)

    def OnMotion(*args, **kwargs):
        """OnMotion(self, MouseEvent event)"""
        return _wxsvg.SVGUIControlBase_OnMotion(*args, **kwargs)

    def OnChar(*args, **kwargs):
        """OnChar(self, KeyEvent event)"""
        return _wxsvg.SVGUIControlBase_OnChar(*args, **kwargs)

_wxsvg.SVGUIControlBase_swigregister(SVGUIControlBase)

class SVGUIControl(SVGUIControlBase):
...
class SVGUINoteBook(SVGUIControl):
    ...
    def RefreshContentSize(*args, **kwargs):
        """RefreshContentSize(self, double scale)"""
        return _wxsvg.SVGUINoteBook_RefreshContentSize(*args, **kwargs)
...
class SVGUITextCtrl(SVGUIControl):
    ...
    def SetText(*args, **kwargs):
        ...
        return _wxsvg.SVGUITextCtrl_SetText(*args, **kwargs)
    ...
    def IsSelected(*args, **kwargs):
        ...
        return _wxsvg.SVGUITextCtrl_IsSelected(*args, **kwargs)
    ...
    def Update_Cursor(*args, **kwargs):
        """Update_Cursor(self)"""
        return _wxsvg.SVGUITextCtrl_Update_Cursor(*args, **kwargs)
...
class SVGUIWindow(SvgXmlDocument,SVGUIContainer,SVGCtrl):
    ...
    def RefreshScale(*args, **kwargs):
        """RefreshScale(self)"""
        return _wxsvg.SVGUIWindow_RefreshScale(*args, **kwargs)

    def GetScale(*args, **kwargs):
        """GetScale(self) -> float"""
        return _wxsvg.SVGUIWindow_GetScale(*args, **kwargs)
    ...
    def GetSVGUIID(*args, **kwargs):
        """GetSVGUIID(wxChar str_id) -> int"""
        return _wxsvg.SVGUIWindow_GetSVGUIID(*args, **kwargs)

    GetSVGUIID = staticmethod(GetSVGUIID)
    def OnLeftDown(*args, **kwargs):
        """OnLeftDown(self, MouseEvent event)"""
    ...
    def OnSize(*args, **kwargs):
        """OnSize(self, SizeEvent event)"""
        return _wxsvg.SVGUIWindow_OnSize(*args, **kwargs)
...
def SVGUIWindow_GetSVGUIID(*args, **kwargs):
  """SVGUIWindow_GetSVGUIID(wxChar str_id) -> int"""
  return _wxsvg.SVGUIWindow_GetSVGUIID(*args, **kwargs)
